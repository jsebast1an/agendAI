...
export default function Landing() {
    return (
        ...
        <Head title="AgendAI — Agenda automática con WhatsApp" />
            <div className="h-screen w-full overflow-hidden bg-neutral-950 text-neutral-100 relative">
                {/* Fondo decorativo (no interactúa, no genera scroll) */}
                <div className="pointer-events-none absolute inset-0 -z-10">
                    <div className="absolute -top-24 -left-24 h-72 w-72 rounded-full bg-fuchsia-600/20 blur-3xl" />
                    <div className="absolute top-40 -right-20 h-80 w-80 rounded-full bg-indigo-600/20 blur-3xl" />
                    <div className="absolute bottom-0 left-1/2 -translate-x-1/2 h-48 w-[36rem] bg-white/5 backdrop-blur-3xl rounded-[3rem] rotate-2" />
                </div>
                    ...
                    <main className="grid flex-1 place-items-center">
                        <section className="w-full">
                            <div className="mx-auto max-w-3xl text-center">
                                ...
                                Reduce ausencias, confirma en un tap y gana tiempo para tu negocio.
                                </h2>
                                ...
                                * Página 1 de 1 (prototipo sin scroll). Más secciones vendrán aquí mismo.
                                </p>
                            </div>
                        </section>
                    </main>
